...
[AddComponentMenu("我的组件/DOTween/DTToggle5_Fade")]
public class DTToggle5_Fade : MonoBehaviour 
{
    ...
    private CanvasGroup mOneGroup, mTwoGroup, mThreeGroup, mFourGroup,mFiveGroup;
    ...
    void Awake()
    {
        ...
        {
            MyLog.Red("这五个游戏对象有空的情况   " + gameObject);
            return;
        }
