...
/// <summary>
/// Implementation of the DragSource interface for the level list
/// </summary>
public class SMLevelListDragSource : CUListDragSource {
	
	private const string PathIdentifier = "levels://data";
