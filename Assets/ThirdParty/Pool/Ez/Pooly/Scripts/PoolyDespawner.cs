...
namespace Ez.Pooly
{
    ...
    [AddComponentMenu("我的组件/对象池/放在预制体")] 
    public class PoolyDespawner : MonoBehaviour            //只要放到预制体上配置参数即可
    {
        ...
        {
            /// <summary>
            /// 这个预制体对象 将在给定时间后 自动消失
            /// </summary>
            Time = 0,


            /// <summary>
            /// 音乐（只要是自己或者子类拥有 Audio Source 并加了音频）播放完成自动消失
            /// </summary>
            /// 
            SoundPlayed = 1,
            ...
            /// <summary>
            /// 特效（只要是自己或者子类拥有 Particle System 即可）播放完成自动消失，或者配置延时多久消失
            /// </summary>
            /// 
            EffectPlayed = 2,
            ...
            /// <summary>
            /// OnCollision 碰撞后消失，或者配置延时多久消失
            /// <para> OnCollision 事件类型是 OnCollisionEnter，OnCollisionStay 和 OnCollisionExit</para>
            /// </summary>
            Collision = 3,


            /// <summary>
            /// OnTrigger 接触后消失，或者配置延时多久消失 
            /// <para> OnTrigger 事件类型是 OnTriggerEnter，OnTriggerStay 和 OnTriggerExit </para>
            /// </summary>
            Trigger = 4,


            /// <summary>
            /// OnCollision2D  2D碰撞后消失，或者配置延时多久消失
            /// <para> OnCollision2D 事件类型是 OnCollisionEnter2D，OnCollisionStay2D 和 OnCollisionExit2D</para>
            /// </summary>
            Collision2D = 5,


            /// <summary>
            /// OnTrigger2D 2D接触后消失，或者配置延时多久消失 
            /// <para> OnTrigger2D 事件类型是 OnTriggerEnter2D，OnTriggerStay2D 和 OnTriggerExit2D </para>
            /// </summary>
            Trigger2D = 6
        ...
        public ParticleSystem pSystem {
            get
            {
                if(_pSystem == null) { _pSystem = GetComponentInChildren<ParticleSystem>(false); } return _pSystem;
            } }
        ...
        // 只要是对象池产生的预制体都会 接收 OnSpawned 和 OnDespawned 方法
