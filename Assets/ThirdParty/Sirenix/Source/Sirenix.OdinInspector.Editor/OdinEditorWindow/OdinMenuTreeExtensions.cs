...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public static class OdinMenuTreeExtensions
    {
        ...
        /// <summary>
        /// 添加指定路径上的所有资产。 找到的每个资产在指定的菜单项路径中都有自己的菜单项
        /// </summary>
        /// <param name="tree">树</param>
        /// <param name="menuPath">菜单项路径</param>
        /// <param name="assetFolderPath">资产文件夹路径.</param>
        /// <param name="type">类型.</param>
        /// <param name="includeSubDirectories">是否在子目录中搜索资源.</param>
        /// <param name="flattenSubDirectories">如果为true，那么assetFolderPath中的子目录将不再在指定的菜单项路径中获得自己的子菜单项.</param>
        /// <returns>返回创建的所有菜单项，以便在指定菜单项路径中添加菜单项.</returns>
        ...
        /// <summary>
        /// A将资产迷你缩略图分配为集合中所有菜单项的图标。 如果菜单项目对象为空，则分配Unity文件夹图标。
        /// </summary>
