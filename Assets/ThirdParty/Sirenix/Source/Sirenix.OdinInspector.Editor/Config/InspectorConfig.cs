...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public class InspectorConfig : GlobalConfig<InspectorConfig>, ISerializationCallbackReceiver
    {
        ...
        private void SuppressMissingEditorTypeErrorsMessage()
        {
            ...
            {
                AllEditorGUI.ErrorMessageBox("Suppressing these error messages may cause crashes on Unity 2017.1 (see Unity issue 920772). A fix is being backported from 2017.2 - meanwhile, you may want to disable this option, and live with the constant error messages about missing editor types.");
            }
        }
