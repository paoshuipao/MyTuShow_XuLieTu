                ...
                if (prop.Next(true))
                {
                    ...
                    do
                    {
                        ...
                        if (member == null)
                        {
                            ...
                            var possibles = members.Where(n => (propName.IsContains(n.Name, StringComparison.InvariantCultureIgnoreCase) || n.Name.IsContains(propName, StringComparison.InvariantCultureIgnoreCase)) && prop.IsCompatibleWithType(n.GetReturnType())).ToList();
