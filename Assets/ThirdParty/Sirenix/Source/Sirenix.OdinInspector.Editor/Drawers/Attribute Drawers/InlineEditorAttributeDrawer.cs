        ...
        protected override void DrawPropertyLayout(IPropertyValueEntry<T> entry, InlineEditorAttribute attribute, GUIContent label)
        {
            ...
            AllEditorGUI.BeginBoxHeader();
            {
                ...
                if (entry.ValueState != PropertyValueState.NullReference)
                {
                    ...
                    context.Value.Toggled.Value = AllEditorGUI.Foldout(rect, context.Value.Toggled.Value, GUIContent.none);
                }
            ...
            if (AllEditorGUI.BeginFadeGroup(UniqueDrawerKey.Create(entry.Property, this), context.Value.Toggled.Value))
            {
                ...
                {
                    AllEditorGUI.InfoMessageBox("Multi object editing is currently not supported for inline editors.");
                }
                else
                {
