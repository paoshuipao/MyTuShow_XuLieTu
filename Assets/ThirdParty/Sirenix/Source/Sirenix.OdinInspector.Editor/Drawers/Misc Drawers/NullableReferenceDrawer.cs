...
#pragma warning disable 0618 // Type or member is obsolete
                newValue = AllEditorGUI.ObjectField(entry, entry.BaseValueType, label, entry.SmartValue, entry.Property.Info.GetAttribute<AssetsOnlyAttribute>() == null);
...
#pragma warning restore 0618 // Type or member is obsolete
            ...
            if (showToggle)
            {
                isToggled = AllEditorGUI.Foldout(GUILayoutUtility.GetLastRect(), isToggled, GUIContent.none);
            }
