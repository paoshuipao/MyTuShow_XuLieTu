    ...
    public sealed class UnityEventDrawer<T> : UnityPropertyDrawer<UnityEditorInternal.UnityEventDrawer, T> where T : UnityEventBase
    {
        protected override void DrawPropertyLayout(IPropertyValueEntry<T> entry, GUIContent label)
        {
            ...
            if (unityProperty == null)
            {
                ...
                {
                    AllEditorGUI.ErrorMessageBox("You have likely forgotten to mark your custom UnityEvent class '" + typeof(T).GetNiceName() + "' with the [Serializable] attribute! Could not get a Unity SerializedProperty for the property '" + entry.Property.NiceName + "' of type '" + entry.TypeOfValue.GetNiceName() + "' at path '" + entry.Property.Path + "'.");
                    return;
                }
            }
        ...
        //    //if (unityProperty == null)
        //    //{
        //    //    AllEditorGUI.ErrorMessageBox("Could not create an alias UnityEditor.SerializedProperty for the property '" + entry.Property.Name + "'.");
        //    //    return;
        //    //}
        ...
        //    {
        //        AllEditorGUI.WarningMessageBox("Cannot properly draw UnityEvents for properties that are not directly serialized by Unity from a component. To get the classic Unity event appearance, please turn " + entry.Property.Name + " into a public field, or a private field with the [SerializedField] attribute on, and ensure that it is defined on a component.");
