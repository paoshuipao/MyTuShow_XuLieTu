...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public class OdinSceneValidatorWindow : EditorWindow
    {
        ...
        /// Opens the window.
        /// </summary>
        [MenuItem("Tools/演示/场景中所有的特性", priority = -15)]
        ...
        private class BehaviourValidationInfo
        {
            ...
            public void DrawMenu()
            {
                ...
                var rect = AllEditorGUI.BeginListItem(true);
                {
                    ...
                    if (this.IsSelected)
                    {
                        ...
                        AllEditorGUI.DrawSolidRect(rect, SirenixGUIStyles.MenuButtonActiveBgColor);
            ...
            public void DrawPropertyTree()
            {
                ...
                GUILayout.BeginVertical(new GUIStyle() { padding = new RectOffset(10, 10, 6, 10) });
                {
                    ...
                    {
                        AllEditorGUI.ErrorMessageBox("Missing Reference.");
                    }
                }
