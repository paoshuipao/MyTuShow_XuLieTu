    ...
    public static class TypeExtensions
    {
        ...
        public static Func<T, T, bool> GetEqualityComparerDelegate<T>()
        {
            ...
            MethodInfo equalityMethod = typeof(T)
                .GetOperatorMethods(EOperator.Equality)
                .FirstOrDefault(x =>
                {
        ...
        /// </summary>
        public static MethodInfo GetOperatorMethod(this Type type, EOperator op)
        {
            string methodName;
            ...
            switch (op)
            {
                ...
                case EOperator.Equality:
                    methodName = "op_Equality";
                    break;

                case EOperator.Inequality:
        ...
        /// Gets the MethodInfo of a specific operator type.
        /// </summary>
        public static MethodInfo[] GetOperatorMethods(this Type type, EOperator op)
        {
            string methodName;
