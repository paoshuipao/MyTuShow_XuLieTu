...
{
    [InitializeOnLoad]
    public static class AllEditorGUI                         // 各种编辑器GUI功能的集合
    {
        ...
        public static float DefaultFadeGroupDuration
        {
            ...
            set
            {
                ...
                EditorPrefs.SetFloat("AllEditorGUI.DefaultFadeGroupDuration", value);
            }
        }
        ...
        public static float TabPageSlideAnimationDuration
        {
            ...
            set
            {
                ...
                EditorPrefs.SetFloat("AllEditorGUI.TabPageSlideAnimationDuration", value);
            }
        }
        ...
        public static float ShakingAnimationDuration
        {
            ...
            set
            {
                ...
                EditorPrefs.SetFloat("AllEditorGUI.ShakingAnimationDuration", value);
            }
        }
        ...
        public static bool ExpandFoldoutByDefault
        {
            ...
            set
            {
                ...
                EditorPrefs.SetBool("AllEditorGUI.ExpandFoldoutByDefault", value);
            }
        }
        ...
        /// </summary>
        public static void Title(string title, string subtitle, TextAlignment textAlignment, bool horizontalLine, bool boldLabel = true,MyEnumColor color =MyEnumColor.Green)
        {
            ...
            if ((int)textAlignment > (int)TextAlignment.Right)
            {
                ...
                if (horizontalLine)
                {
                    AllEditorGUI.HorizontalLineSeparator(SirenixGUIStyles.LightBorderColor, 1);
                    GUILayout.Space(3f);
                }
            }
            else
            {
                ...
                if (horizontalLine)
                {
                    AllEditorGUI.DrawSolidRect(rect.AlignBottom(1), SirenixGUIStyles.LightBorderColor);
                    GUILayout.Space(3f);
                }
            }
...
#pragma warning restore 0618 // Type or member is obsolete
        ...
        public static GUITabGroup CreateAnimatedTabGroup(object key)
        {
            ...
            t.AnimationSpeed = 1f / AllEditorGUI.TabPageSlideAnimationDuration;
            return t;
        }
        ...
        internal static void BeginDrawOpenInspector(Rect rect, UnityEngine.Object obj, Rect btnRect)
        {
            ...
            if (AllEditorGUI.IconButton(rect, EditorIcons.Transparent, "Inspect object"))
            {
        ...
        {
            defaultFadeGroupDuration = EditorPrefs.GetFloat("AllEditorGUI.DefaultFadeGroupDuration", defaultFadeGroupDuration);
            tabPageSlideAnimationDuration = EditorPrefs.GetFloat("AllEditorGUI.TabPageSlideAnimationDuration", tabPageSlideAnimationDuration);
            shakingAnimationDuration = EditorPrefs.GetFloat("AllEditorGUI.ShakingAnimationDuration", shakingAnimationDuration);
            expandFoldoutByDefault = EditorPrefs.GetBool("AllEditorGUI.ExpandFoldoutByDefault", expandFoldoutByDefault);
        }
