...
namespace Sirenix.Utilities.Editor
{
    ...
    public static class GUIHelper
    {
        ...
        {
            FadeGroupDurationStack.Push(AllEditorGUI.DefaultFadeGroupDuration);
            AllEditorGUI.DefaultFadeGroupDuration = duration;
        }
        ...
        {
            AllEditorGUI.DefaultFadeGroupDuration = FadeGroupDurationStack.Pop();
        }
        ...
        {
            TabPageSlideAnimationDurationStack.Push(AllEditorGUI.TabPageSlideAnimationDuration);
            AllEditorGUI.TabPageSlideAnimationDuration = duration;
        }
        ...
        {
            AllEditorGUI.TabPageSlideAnimationDuration = TabPageSlideAnimationDurationStack.Pop();
        }
