...
namespace Sirenix.Utilities.Editor
{
    ...
    /// <example>
    /// <code>
    /// var tabGroup = AllEditorGUI.CreateAnimatedTabGroup(someKey);
    ...
    public class GUITabGroup
    {
        ...
        private void DrawToolbar()
        {
            ...
            if (Event.current.OnRepaint())
            {
                AllEditorGUI.DrawBorders(new Rect(GUILayoutUtility.GetLastRect()) { height = this.toolbarHeight }, 1, 1, 0, 0);
            }
