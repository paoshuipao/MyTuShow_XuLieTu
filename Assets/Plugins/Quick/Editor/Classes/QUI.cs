...
namespace QuickEditor
{
    ...
    public static class QUI
    {
        ...
        public static void DrawTexture(Rect rect, Texture texture)
        {
            if (texture == null)
            {
                Debug.Log("[QUI] Texture is null!"); return;
            }
            GUI.DrawTexture(rect, texture);
        }
        ...
        public static void Popup(SerializedProperty serializedProperty, float width,string[] displayNames)
        {
            serializedProperty.enumValueIndex = EditorGUILayout.Popup(serializedProperty.enumValueIndex, displayNames, GUILayout.Width(width));
        }
        ...
        /// <param name="content">Text, image and tooltip for this box.</param>
        /// <param name="style">The style to use. If left out, the box style from the current GUISkin is used.</param>
        public static void Box(GUIContent content, GUIStyle style, float width, float height)
        {
